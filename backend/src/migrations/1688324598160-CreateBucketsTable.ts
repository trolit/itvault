...
export class CreateBucketsTable1688324598160 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`buckets\` (\`id\` int NOT NULL AUTO_INCREMENT, \`value\` json NOT NULL, \`blueprintId\` int NULL, \`variantId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
