...
export class SetDefaultOfEnabledPropertyInPermissionToRole1679260845721 implements MigrationInterface {
    name = 'SetDefaultOfEnabledPropertyInPermissionToRole1679260845721'
