...
export class CreateVariantsTable1688323924425 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`variants\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`filename\` varchar(255) NOT NULL, \`size\` int NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`createdById\` int NULL, \`fileId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
